...
def main():
    ...
    lockphase.set_time_options(fix_initial=True, initial_val=0, fix_duration=False, units='s') # set time options for simulation
    ...
    lockphase.add_control('tau',opt=True, lower = 0, upper = 10, fix_initial=False, units='N*m') # add control torque
