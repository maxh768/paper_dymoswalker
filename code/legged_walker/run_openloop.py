...
def main():
    ...
    """
    states_init = {'q1': 15*(np.pi / 180), 'q1_dot': 0, 'q2': 20*(np.pi / 180), 'q2_dot': 0}
    states_final = {'q1': -30*(np.pi / 180), 'q1_dot': 0, 'q2': -30*(np.pi / 180), 'q2_dot': 0}
    ...
    #states
    lockphase.add_state('q1', fix_initial=True, rate_source='q1_dot', units='rad')
    lockphase.add_state('q1_dot', fix_initial=True, rate_source='q1_dotdot', units='rad/s')
    lockphase.add_state('q2', fix_initial=True, rate_source='q2_dot', units='rad')
    lockphase.add_state('q2_dot', fix_initial=True,  rate_source='q2_dotdot', units='rad/s')
    ...
    # start constraints
    lockphase.add_boundary_constraint('q1', loc='initial', equals=states_init['q1'], units='rad')
    lockphase.add_boundary_constraint('q1_dot', loc='initial', equals=states_init['q1_dot'], units='rad/s')
    lockphase.add_boundary_constraint('q2', loc='initial', equals=states_init['q2'], units='rad')
    lockphase.add_boundary_constraint('q2_dot', loc='initial', equals=states_init['q2_dot'], units='rad/s')
